...
int z,y;
   ...
   void  change_color(){
    ...
    public ac(String q,int io,String w,int ip,String p) {
        try{
        start=q;
        stop=w;
        z=io+1;
        ...
        ResultSet rs=db.dbconnect.st3.executeQuery("select * from ac");
        while(rs.next())
        {
...
if(b24.isSelected()&&!b24.getBackground().equals(Color.red))
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        {  
            ...
            { busseats+=i+",";
             db.dbconnect.st1.executeUpdate("update ac set "+ start+"='a' ,"+stop+"='a' where seats="+i+"");
            }
        }
